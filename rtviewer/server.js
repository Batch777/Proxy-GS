...
const server = http.createServer((req, res) => {
  ...
  // NOTE: do NOT path.normalize() here — on Windows it collapses the leading
  // \\ of UNC paths (\\wsl.localhost\...), breaking fs.stat. path.join alone
  // already resolves "." / ".." segments and preserves the UNC prefix.
